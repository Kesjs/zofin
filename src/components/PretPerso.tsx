...
const LOCAL_STORAGE_KEY = 'pretPersoData'; // Ajout
...
const PretPersonnel: React.FC = () => {
  ...
  }, [currentStep, isAccepted, nom, email, telephone, adresse, codePostal, ville, montant, duree, paymentConfirmed]);
 ...
 const nextStep = useCallback(() => {
  setCurrentStep((prev) => {
    switch (prev) {
      ...
      case 'documents': return 'summary';  // <-- changement ici
      case 'summary': return 'payment';   // <-- étape résumé avant paiement
