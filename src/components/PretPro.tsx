...
type Step = 'intro' | 'conditions' | 'form' | 'documents' | 'recap' | 'payment' | 'confirmation';
  ...
  const nextStep = useCallback(() => {
    setCurrentStep((prev) => {
      switch (prev) {
        ...
        case 'documents': return 'recap';
        case 'recap': return 'payment';
  ...
  const prevStep = useCallback(() => {
    setCurrentStep((prev) => {
      switch (prev) {
        ...
        case 'payment': return 'recap';
        case 'recap': return 'documents';
        ...
        <AnimatePresence mode="wait">
          {currentStep === 'intro' && (
            ...
            >
              <p className="text-gray-700 mb-6">
                Bienvenue sur notre service de demande de prêt Pro. Ce processus comporte plusieurs étapes pour garantir la validité de votre dossier.
              </p>
              <div className="mb-6">
              ...
              <button
                ...
                aria-label="Commencer la demande de prêt"
            ...
            >
              ...
              <div className="flex justify-end gap-3">
                <button
                  ...
                  aria-label="Continuer après acceptation des conditions"
                  className="bg-blue-900 text-white px-5 py-2 rounded hover:bg-yellow-500 transition"
                >
                  Continuer
                </button>
          ...
          {currentStep === 'recap' && (
            ...
            >
              ...
              <div className="bg-gray-50 border rounded-lg shadow-sm p-4">
                <h4 className="text-md font-semibold mb-2 text-gray-800">💼 Détails du prêt professionnel</h4>
              ...
              {!paymentConfirmed ? (
                <div className="flex justify-between">
                  ...
                  <button
                    ...
                    aria-label="Procéder au paiement des frais de dossier de 50 euros"
                    className="bg-blue-900 text-white px-5 py-2 rounded hover:bg-yellow-500 transition"
                  >
                    Payer 50 €
                  </button>
